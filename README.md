...
4. Run API:
   ...
   ```
5. Open `http://localhost:${PORT:-8080}/health`.
...
- Public URL: `https://pmp-production-c885.up.railway.app`
- Runtime port: `8080` (Railway also provides `$PORT`, which is honored by the Docker CMD).
- Health check: `https://pmp-production-c885.up.railway.app/health`
